...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (f_continue) {
			...
			System.out.println("8 to show averege of the lecturers in college");
			...
			case 1:
				...
				while (!is_added) {
					...
					try {
						...
						System.err.println("Lecturer exists in the system, adding failed try again");
					}
				}
				break;
			case 2:
			...
			case 3:
				...
				while(!is_added3) {
					...
					if(college.add_lecturer_to_committee(committee_name, lecturer_name)) {
						is_added3 = true;
			...
			case 4:
				...
				while(!is_changed) {
					...
					if (college.update_committee_chairman(committee_name,new_chairman_name)) {
			...
			case 5:
				...
				while (!removed) {
					...
					String lecturer_name = s.nextLine();
					if (college.remove_lecturer_from_commmittee(lecturer_name,committee_name)) {
			...
			case 6:
				...
				while(!is_added4) {
					...
					if (college.add_department(department_name,num_of_students)) {
			...
			case 7:
				...
				while(!is_added5){
					...
					String lecturer_name = s.nextLine();
					if (college.AddLecturerToDepartment(lecturer_name,department_name)) {
				...
				break;
			case 8:
				System.out.println("The lecturers' average is" + college.get_lecturers_avg());
				break;
			case 9:
